          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-sm text-gray-600 font-medium">
              {[
                ...
                { label: 'FAQ', id: 'faq' },
                { label: 'Return & Refund Policy', id: 'return-refund-policy' },
                { label: 'Terms & Conditions', id: 'terms-and-conditions' },
                { label: 'Shipping & Delivery Policy', id: 'shipping-policy' },
              ].map((link) => (
                <li key={link.id}>
                  <button onClick={() => goTo(link.id)} className="hover:text-[#005550] transition-colors cursor-pointer">
                    {link.label}
                  </button>
                </li>
              ))}
