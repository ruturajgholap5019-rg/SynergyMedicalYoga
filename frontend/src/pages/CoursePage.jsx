...
export default function CoursePage({ setActivePage }) {
  ...
  return (
    <div className="bg-white font-inter text-[#444444]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="flex justify-center">
            <img
              ...
              className="w-full max-w-6xl h-auto max-h-[500px] object-contain rounded-3xl shadow-md border border-gray-200"
            />
          </div>
        </div>
      </section>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-xs font-normal ${openWeekend === 4 ? 'text-amber-200' : 'text-amber-200'}`}>Fri: Full Day (9 Hours) Sat: Full Day (9 Hours) Sun: Full Day (9 Hours)</p>
                  </div>
                </div>
      ...
      {/* ── ENROLLMENT MODAL ── (FULLY IMPLEMENTED) */}
      {isEnrollModalOpen && (
