      ...
      <div className="text-center space-y-3 pt-3 border-t border-gray-100">
        ...
        {hasOptions && (
          <div className="flex items-center justify-center gap-2">
            ...
            <select
              ...
              className="text-xs font-semibold bg-gray-50 border border-gray-200 rounded-lg px-2.5 py-1 text-gray-700 focus:outline-none focus:border-[#005550]"
            >
        ...
        <div className="flex flex-col sm:grid sm:grid-cols-2 gap-2 pt-1">
          <button
            type="button"
            onClick={handleAdd}
            className={`font-bold py-2.5 px-3 text-xs rounded-xl transition-all shadow-xs flex items-center justify-center gap-1.5 cursor-pointer ${
              isAdded
                ? 'bg-emerald-600 text-white'
                : 'bg-teal-50 hover:bg-teal-100 text-[#005550] border border-teal-200'
            }`}
          >
            {isAdded ? (
              <>
